      ...
      <header className="bg-blue-900 text-white shadow-lg">
        <div className="container mx-auto px-4 py-6 flex flex-col md:flex-row justify-between items-center">
          <Link to="/" className="flex items-center space-x-3 mb-4 md:mb-0">
            ...
            <div>
              <h1 className="text-xl font-bold tracking-tight">PMB ONLINE MAS SALAFIYAH KEREK</h1>
              <p className="text-xs text-blue-200 uppercase tracking-widest">Penerimaan Murid Baru</p>
            </div>
          </Link>
      ...
      <footer className="bg-slate-900 text-slate-400 py-12">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
            <div>
              <h3 className="text-white font-semibold mb-4 text-lg">PMB Online</h3>
            ...
            <div>
              ...
              <ul className="text-sm space-y-2">
                <li className="flex items-center">
                   ...
                   Jl. Raya Kerek-Tuban (Depan Telkom) Margomulyo
                </li>
                <li className="flex items-center">
          ...
          <div className="border-t border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center text-xs">
            <p>&copy; 2026 PMB MAS SALAFIYAH By:Trisno_Admin. Hak Cipta Dilindungi.</p>
